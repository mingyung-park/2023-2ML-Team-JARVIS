...
[Features] - code/config/experiment3.json
- total count
- incoming count
  - of total packet
...
CONFIG_PATH = "code/config/experiment3.json"
DATASET_PATH = "data/experiment3.pkl"


def do_experiment(base_path, result_dir="../result/experiment3"):
